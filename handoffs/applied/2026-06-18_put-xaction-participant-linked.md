<!-- TARGET: PUT /v1/xaction-participants/{xactionParticipantId}/linked-contact/{linkedContactId} -->
<!-- FORMAT: RAW_PASTE -->

<!-- SUMMARY -->
Set or Replace the Linked Contact of a Transaction Participant
...
200	
The updated Transaction Participant with its new linked Contact.
...
No links
403	
Forbidden - The authenticated user does not have access to the Transaction Participant's Transaction, or does not have access to the Contact identified by linkedContactId.
...
No links
404	
Not Found - The Transaction Participant or the Contact identified by linkedContactId does not exist.
